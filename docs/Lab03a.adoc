...
2. Now, we are using the Dockerfile as the basis to create a *docker
...
7.  Now, you can get the *list of pods*, Run the following command given
below.

....
oc get pods
....
8.  Now, add a *route* to expose that service, Run the following command
given below.
...
11.  To run the *application*, copy the host/port and paste in browser
