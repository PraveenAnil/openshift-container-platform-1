...
+
image:https://raw.githubusercontent.com/SpektraSystems/openshift-container-platform/master/images/2odl_register.jpg[Training Portal Register1,float="left"]
+
...
+
image:https://raw.githubusercontent.com/SpektraSystems/openshift-container-platform/master/images/2odl_register2.jpg[Training Portal Register2,float="left"]
+
3. You will see the environment details soon below.
+
image:https://raw.githubusercontent.com/SpektraSystems/openshift-container-platform/master/images/2odl_register3.jpg[Training Portal Register3,float="left"] + Please ensure to take the values assigned to your deployment.
...
+
image:https://raw.githubusercontent.com/SpektraSystems/openshift-container-platform/master/images/3azure_login.jpg[AzureLogin,role="left"]
+
image:https://raw.githubusercontent.com/SpektraSystems/openshift-container-platform/master/images/3azure_login1.jpg[Azure Login,float="left"]
+
    Note : At the first login, you may have to change the password, if asked for

2. *Enter* a new *password*. Then select *Update password and sign in*. 
+
image:https://raw.githubusercontent.com/SpektraSystems/openshift-container-platform/master/images/4update_password.jpg[Azure Login,align="left"]

3. Now, you will be directed to the *Azure Dashboard*.
+
image:https://raw.githubusercontent.com/SpektraSystems/openshift-container-platform/master/images/6azure_dashboard.jpg[Azure Dashboard,float="left"]
+
4. *Click* on *Microsoft Azure* at the top left corner of the screen, to view the Dashboard. 
+
image:https://raw.githubusercontent.com/SpektraSystems/openshift-container-platform/master/images/7microsoftazure.jpg[Microsoft Azure,float="left"]
+
5. To toggle *show/hide* the Portal menu options with icon, *Click* on the *Show Menu* button.
+
image:https://raw.githubusercontent.com/SpektraSystems/openshift-container-platform/master/images/8azure_menu.jpg[Azure Menu,float="left"]
+
6. *Click* on the *Resource groups* button in the *Menu navigation* bar to view the *Resource groups* blade.
+
image:https://raw.githubusercontent.com/SpektraSystems/openshift-container-platform/master/images/9resourcegroup.jpg[Resource Group,float="left"]
+
7. You will see a *Resource Group* which you have access to, *click* on it.
+
image:../images/10select_rg.jpg[Select RG,float="left"]
+
...
+
image:https://raw.githubusercontent.com/SpektraSystems/openshift-container-platform/master/images/11access_control.jpg[Access Control,float="left"]
+
9. In the new blade that come up, you can see the *role* that is assigned to you. 
+
image:https://raw.githubusercontent.com/SpektraSystems/openshift-container-platform/master/images/12role.jpg[Role,float="left"]
+
...
+
image:https://raw.githubusercontent.com/SpektraSystems/openshift-container-platform/master/images/3azure_login2.jpg[Azure Login,float="left"] 
+
image:https://raw.githubusercontent.com/SpektraSystems/openshift-container-platform/master/images/3azure_login3.jpg[Azure Login,float="left"]
+
2. Now, you will be directed to the *Azure Dashboard*
+
image:https://raw.githubusercontent.com/SpektraSystems/openshift-container-platform/master/images/5azure_dashboard.jpg[Azure Dashboard,float="left"]
+
...
+
image:https://raw.githubusercontent.com/SpektraSystems/openshift-container-platform/master/images/14selectazure_ad.jpg[Resource Group,float="left"]
+
6. You will be directed to the Azure Active Directory blade, *click* on *App registrations*.
+
image:https://raw.githubusercontent.com/SpektraSystems/openshift-container-platform/master/images/15app_reg.jpg[Resource Group,float="left"]
+
7. In the next blade, *click* on *New Application Registration* on top of the blade.
+
image:https://raw.githubusercontent.com/SpektraSystems/openshift-container-platform/master/images/16new_appreg.jpg[Resource Group,float="left"]
+
...
+
image:https://raw.githubusercontent.com/SpektraSystems/openshift-container-platform/master/images/17createapp.jpg[Resource Group,float="left"]
+
...
+
image:https://raw.githubusercontent.com/SpektraSystems/openshift-container-platform/master/images/18check_app.jpg[Resource Group,float="left"] + If the app has been created, you can see it in the results as shown above.
...
+
image:https://raw.githubusercontent.com/SpektraSystems/openshift-container-platform/master/images/19app_id.jpg[Resource Group,float="left"]
+
12. Now, *Click* on *Keys* in the settings blade. 
+
image:https://raw.githubusercontent.com/SpektraSystems/openshift-container-platform/master/images/20app_key.jpg[Resource Group,float="left"]
+
...
* And *Click* on *Save.*
+
image:https://raw.githubusercontent.com/SpektraSystems/openshift-container-platform/master/images/21save_key.jpg[Resource Group,float="left"]
+
...
+
image:https://raw.githubusercontent.com/SpektraSystems/openshift-container-platform/master/images/22copy_key.jpg[Resource Group,float="left"]
+
...
+
image:https://raw.githubusercontent.com/SpektraSystems/openshift-container-platform/master/images/9resourcegroup1.jpg[Resource Group,float="left"]
+
...
+
image:https://raw.githubusercontent.com/SpektraSystems/openshift-container-platform/master/images/9resourcegroup2.jpg[Resource Group,float="left"]
+
...
+
image:https://raw.githubusercontent.com/SpektraSystems/openshift-container-platform/master/images/22access_control.jpg[Access Control,float="left"]
+
...
that)* 
+
image:https://raw.githubusercontent.com/SpektraSystems/openshift-container-platform/master/images/22access_control1.jpg[Access Control,float="left"]
+
