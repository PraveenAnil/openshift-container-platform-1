...
+
image:https://github.com/PraveenAnil/openshift-container-platform-1/blob/master/images/2odl_register.jpg[Training Portal Register1]
...
+image:../images/2odl_register3.jpg[Training Portal Register3] Please ensure to take the values assigned to your deployment.
