...
+
image:https://raw.githubusercontent.com/SpektraSystems/openshift-container-platform/master/images/3azure_login1.jpg[Azure Login,role="left"]
+
    Note : At the first login, you may have to change the password, if asked for

2. *Enter* a new *password*. Then select *Update password and sign in*. 
+
image:https://raw.githubusercontent.com/SpektraSystems/openshift-container-platform/master/images/4update_password.jpg[Azure Login,role="left"]
