...
by providing all required information and *clicking* on *SUBMIT button*.
...
1.  *Enter* a new *password*. Then select *Update password and sign in*.
...
to view the *Resource groups* blade.
“image:../images/9resourcegroup.jpg[Resource Group]
2.  You will be directed to the *Resource groups* blade, *click* on *+
Add*. “image:../images/9resourcegroup1.jpg[Resource Group]
3.  In the *Create* blade, *configure* as follows and then *click* on
*Create*.
